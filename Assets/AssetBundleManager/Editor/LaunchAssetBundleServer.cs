...
namespace AssetBundles
{
   ...
   //         Process launchProcess = Process.Start(startInfo);
            ...
            myProcess.StartInfo.FileName = pathToAssetServer;
            myProcess.StartInfo.Arguments = args;
            myProcess.StartInfo.WorkingDirectory = Path.Combine(System.Environment.CurrentDirectory, "AssetBundles");
            myProcess.StartInfo.Verb = "runas";
            myProcess.Start();
            Process launchProcess = myProcess;
